...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const resetEditState = (formType) => {
        ...
        if (submitBtn) {
            ...
            switch(formType) {
                ...
                default: addText = 'Aggiungi'; break;
            }
        ...
        // Questa chiamata deve avvenire SOLO per la sezione trasporti
    ...
    // ==========================================================================
    const renderTripDetails = (trip) => { /* ... Implementazione invariata ... */ };
    const populateDatalists = (trip) => { /* ... Implementazione invariata ... */ };
    const renderParticipants = (participants = []) => { /* ... Implementazione invariata ... */ };
    const renderReminders = (reminders = []) => { /* ... Implementazione invariata ... */ };
    const renderTransportations = (transportations = []) => { /* ... Implementazione invariata ... */ };
    const renderAccommodations = (accommodations = []) => { /* ... Implementazione invariata ... */ };
    const renderItinerary = (itinerary = []) => { /* ... Implementazione invariata ... */ };
    const renderBudget = (budget = { items: [] }) => { /* ... Implementazione invariata ... */ };
    const renderPackingList = (packingList = []) => { /* ... Implementazione invariata ... */ };
    const createPackingListItem = (item) => { /* ... Implementazione invariata ... */ };
